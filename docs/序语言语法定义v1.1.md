...
// 单表达式形式
────────────────────────────────────────────────────────────
Γ ⊢ |params| expr ⇓ FuncVal(params, Return(expr), Γ)

// 块形式（带返回类型）
────────────────────────────────────────────────────────────
Γ ⊢ |params| -> T { body } ⇓ FuncVal(params, body, Γ)

// 空参数形式
────────────────────────────────────────────────────────────
Γ ⊢ || expr ⇓ FuncVal([], Return(expr), Γ)
```
...
Γ ∪ {x₁ ↦ (v₁, false), ..., xₙ ↦ (vₙ, false)} ⊢ body ⇒ Γ'
────────────────────────────────────────────────────────────────
Γ ⊢ when x₁ = e₁, ..., xₙ = eₙ { body } ⇒ Γ

∃i. Γ ⊢ eᵢ ⇓ OptionVal(none)
────────────────────────────
Γ ⊢ when x₁ = e₁, ..., xₙ = eₙ { body } ⇒ Γ    // 不执行任何操作
```
...
```
// 默认私有
define(x, v) ⇒ local_only(x, v)

// pub 标记为公开
pub define(x, v) ⇒ export(x, v)
```
...
// 修改（原地）
ListVal(vs).push(v) ⇓ append(vs, v); unit
```
